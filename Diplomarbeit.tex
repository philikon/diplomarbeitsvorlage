...
% - BCOR8mm: links 8 mm zusätzlicher Rand fürs Binden
% - DIV15: Festlegung der Seitenränder mit Zahlen zwischen 1 und 15
...
\documentclass[12pt,oneside,BCOR8mm,DIV15,headinclude,liststotoc,bibtotoc,tablecaptionabove,ngerman,dvipdfm]{scrbook}
...
% Bildunterschrift 0.8 cm einrücken, Größe small, Abbildung wird fett geschrieben
...
% Kopfzeile mit Kapitel- und Abschnittsname, Fußzeile mit Seitennummer
\usepackage{fancyhdr}
\pagestyle{fancy}
...
% Seiten bis zum Beginn des eigentlichen Textes mit römischen Seitenzahlen in der Fußzeile
\frontmatter
\pagestyle{plain}
...
\mainmatter
\pagestyle{fancy}               % Oben definierte Kopf- und Fußzeile verwenden
...
\bibliographystyle{alphadin}  % Zitierstil: alphadin = [Nam88]
